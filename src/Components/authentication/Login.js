...
import { Card, Form, Button, Alert,FormControl, Nav, Navbar } from "react-bootstrap";
    ...
    <div className="content">
      ...
      <div className="form">
        <div className="form-group">
          ...
          <input className="email" type="text" name="username" placeholder="email" ref={emailRef} required />
        </div>
        <div className="form-group">
    ...
    <div className="footer">
      ...
      <Nav.Link className="" href="#link">
        <button type="button" class="btn btn-default btn-lg">
          <a href="/signup" style={{"color": "#fff"}}>Register</a>
        </button>
      </Nav.Link>
